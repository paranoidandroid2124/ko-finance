...
def watchlist_enabled(plan: PlanContext, user_settings: Optional[user_settings_service.UserLightMemSettings]) -> bool:
    """Whether LightMem watchlist personalization should run."""
