...
import { FileText, Calendar, Building2, CheckCircle2 } from "lucide-react";
...
export function FilingSearchCard({ parsed_params, onExecute, onEdit }: FilingSearchCardProps) {
