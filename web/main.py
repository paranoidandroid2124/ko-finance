...
app.include_router(routers.feed.router, prefix="/api/v1")
...
app.include_router(routers.disclosure_viewer.router, prefix="/api/v1")
app.include_router(routers.user_settings.router, prefix="/api/v1")
app.include_router(routers.share.router, prefix="/api/v1")
